...
from nthx_fusion.filesystem import create_directory, is_directory, is_file, remove_directory
from nthx_fusion.types import JobStatus
...
def get_test_jobs_directory() -> str:
	return os.path.join(tempfile.gettempdir(), 'nthx_fusion-test-jobs')
...
def get_test_examples_directory() -> str:
	return os.path.join(tempfile.gettempdir(), 'nthx_fusion-test-examples')
...
def get_test_outputs_directory() -> str:
	return os.path.join(tempfile.gettempdir(), 'nthx_fusion-test-outputs')
