...
from nthx_fusion import config, content_analyser, face_classifier, face_detector, face_landmarker, face_masker, face_recognizer, inference_manager, logger, state_manager, translator, video_manager
from nthx_fusion.common_helper import create_int_metavar, get_middle
from nthx_fusion.download import conditional_download_hashes, conditional_download_sources, resolve_download_url
from nthx_fusion.face_creator import scale_face
from nthx_fusion.face_helper import paste_back, warp_face_by_face_landmark_5
from nthx_fusion.face_masker import create_box_mask, create_occlusion_mask
from nthx_fusion.face_selector import select_faces
from nthx_fusion.filesystem import in_directory, is_image, is_video, resolve_relative_path, same_file_extension
from nthx_fusion.processors.live_portrait import create_rotation, limit_expression
from nthx_fusion.processors.modules.expression_restorer import choices as expression_restorer_choices
from nthx_fusion.processors.modules.expression_restorer.types import ExpressionRestorerInputs
from nthx_fusion.processors.types import LivePortraitExpression, LivePortraitFeatureVolume, LivePortraitMotionPoints, LivePortraitPitch, LivePortraitRoll, LivePortraitScale, LivePortraitTranslation, LivePortraitYaw, ProcessorOutputs
from nthx_fusion.program_helper import find_argument_group
from nthx_fusion.thread_helper import conditional_thread_semaphore, thread_semaphore
from nthx_fusion.types import ApplyStateItem, Args, DownloadScope, Face, InferencePool, ModelOptions, ModelSet, ProcessMode, VisionFrame
from nthx_fusion.vision import read_static_image, read_static_video_chunk, read_static_video_frame
...
def register_args(program : ArgumentParser) -> None:
	...
	if group_processors:
		...
		nthx_fusion.jobs.job_store.register_step_keys([ 'expression_restorer_model', 'expression_restorer_factor', 'expression_restorer_areas' ])
