...
from nthx_fusion.common_helper import create_int_metavar, is_macos
...
from nthx_fusion.processors.modules.frame_colorizer import choices as frame_colorizer_choices
from nthx_fusion.processors.modules.frame_colorizer.types import FrameColorizerInputs
...
from nthx_fusion.types import ApplyStateItem, Args, DownloadScope, InferencePool, InferenceProvider, ModelOptions, ModelSet, ProcessMode, VisionFrame
from nthx_fusion.vision import blend_frame, read_static_image, read_static_video_chunk, read_static_video_frame, unpack_resolution
...
def register_args(program : ArgumentParser) -> None:
	...
	if group_processors:
		...
		nthx_fusion.jobs.job_store.register_step_keys([ 'frame_colorizer_model', 'frame_colorizer_blend', 'frame_colorizer_size' ])
