...
from nthx_fusion.face_helper import merge_matrix, paste_back, scale_face_landmark_5, warp_face_by_face_landmark_5
...
from nthx_fusion.processors.modules.age_modifier import choices as age_modifier_choices
from nthx_fusion.processors.modules.age_modifier.types import AgeModifierDirection, AgeModifierInputs
...
from nthx_fusion.vision import match_frame_color, read_static_image, read_static_video_chunk, read_static_video_frame
...
def register_args(program : ArgumentParser) -> None:
	...
	if group_processors:
		...
		nthx_fusion.jobs.job_store.register_step_keys([ 'age_modifier_model', 'age_modifier_direction' ])
