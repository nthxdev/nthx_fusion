...
from nthx_fusion.processors.modules.frame_enhancer import choices as frame_enhancer_choices
from nthx_fusion.processors.modules.frame_enhancer.types import FrameEnhancerInputs
...
from nthx_fusion.vision import blend_frame, create_tile_frames, merge_tile_frames, read_static_image, read_static_video_chunk, read_static_video_frame
...
def register_args(program : ArgumentParser) -> None:
	...
	if group_processors:
		...
		nthx_fusion.jobs.job_store.register_step_keys([ 'frame_enhancer_model', 'frame_enhancer_blend' ])
