...
from nthx_fusion.download import conditional_download_hashes, conditional_download_sources, resolve_download_url_by_provider
...
from nthx_fusion.filesystem import get_file_name, in_directory, is_image, is_video, resolve_file_paths, resolve_relative_path, same_file_extension
from nthx_fusion.processors.modules.deep_swapper import choices as deep_swapper_choices
from nthx_fusion.processors.modules.deep_swapper.types import DeepSwapperInputs, DeepSwapperMorph
from nthx_fusion.processors.types import ProcessorOutputs
from nthx_fusion.program_helper import find_argument_group
from nthx_fusion.thread_helper import thread_semaphore
from nthx_fusion.types import ApplyStateItem, Args, DownloadScope, Face, InferencePool, Mask, ModelOptions, ModelSet, ProcessMode, VisionFrame
from nthx_fusion.vision import conditional_match_frame_color, read_static_image, read_static_video_chunk, read_static_video_frame
...
def register_args(program : ArgumentParser) -> None:
	...
	if group_processors:
		...
		nthx_fusion.jobs.job_store.register_step_keys([ 'deep_swapper_model', 'deep_swapper_morph' ])
