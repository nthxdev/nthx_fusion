...
from nthx_fusion import config, content_analyser, face_classifier, face_detector, face_landmarker, face_masker, face_recognizer, logger, state_manager, translator, video_manager
from nthx_fusion.common_helper import get_middle
from nthx_fusion.face_creator import scale_face
from nthx_fusion.face_helper import warp_face_by_face_landmark_5
...
from nthx_fusion.filesystem import in_directory, is_image, is_video, same_file_extension
from nthx_fusion.processors.modules.face_debugger import choices as face_debugger_choices
from nthx_fusion.processors.modules.face_debugger.types import FaceDebuggerInputs
from nthx_fusion.processors.types import ProcessorOutputs
from nthx_fusion.program_helper import find_argument_group
from nthx_fusion.types import ApplyStateItem, Args, Face, InferencePool, ProcessMode, VisionFrame
...
def register_args(program : ArgumentParser) -> None:
	...
	if group_processors:
		...
		nthx_fusion.jobs.job_store.register_step_keys([ 'face_debugger_items' ])
