...
from nthx_fusion import state_manager, translator, voice_extractor
from nthx_fusion.filesystem import is_video
from nthx_fusion.types import VoiceExtractorModel
...
def render() -> None:
	...
	VOICE_EXTRACTOR_MODEL_DROPDOWN = gradio.Dropdown(
		...
		choices = nthx_fusion.choices.voice_extractor_models,
