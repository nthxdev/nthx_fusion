...
def render() -> None:
	...
	EXPRESSION_RESTORER_MODEL_DROPDOWN = gradio.Dropdown(
		label = translator.get('uis.model_dropdown', 'nthx_fusion.processors.modules.expression_restorer'),
	...
	EXPRESSION_RESTORER_FACTOR_SLIDER = gradio.Slider(
		label = translator.get('uis.factor_slider', 'nthx_fusion.processors.modules.expression_restorer'),
	...
	EXPRESSION_RESTORER_AREAS_CHECKBOX_GROUP = gradio.CheckboxGroup(
		label = translator.get('uis.areas_checkbox_group', 'nthx_fusion.processors.modules.expression_restorer'),
