...
def render() -> None:
	...
	EXECUTION_THREAD_COUNT_SLIDER = gradio.Slider(
		...
		step = calculate_int_step(nthx_fusion.choices.execution_thread_count_range),
		minimum = nthx_fusion.choices.execution_thread_count_range[0],
		maximum = nthx_fusion.choices.execution_thread_count_range[-1]
	)
