...
from nthx_fusion.processors.modules.age_modifier.types import AgeModifierModel
...
def render() -> None:
	...
	AGE_MODIFIER_MODEL_DROPDOWN = gradio.Dropdown(
		label = translator.get('uis.model_dropdown', 'nthx_fusion.processors.modules.age_modifier'),
	...
	AGE_MODIFIER_DIRECTION_SLIDER = gradio.Slider(
		label = translator.get('uis.direction_slider', 'nthx_fusion.processors.modules.age_modifier'),
