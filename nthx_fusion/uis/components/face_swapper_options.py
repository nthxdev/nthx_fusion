...
from nthx_fusion.common_helper import calculate_float_step, get_first
...
from nthx_fusion.processors.modules.face_swapper.types import FaceSwapperModel, FaceSwapperWeight
...
def render() -> None:
	...
	FACE_SWAPPER_MODEL_DROPDOWN = gradio.Dropdown(
		label = translator.get('uis.model_dropdown', 'nthx_fusion.processors.modules.face_swapper'),
	...
	FACE_SWAPPER_PIXEL_BOOST_DROPDOWN = gradio.Dropdown(
		label = translator.get('uis.pixel_boost_dropdown', 'nthx_fusion.processors.modules.face_swapper'),
	...
	FACE_SWAPPER_WEIGHT_SLIDER = gradio.Slider(
		label = translator.get('uis.weight_slider', 'nthx_fusion.processors.modules.face_swapper'),
