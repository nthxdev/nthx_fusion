...
from nthx_fusion.types import Color, WebcamMode
from nthx_fusion.uis.types import JobManagerAction, JobRunnerAction, PreviewMode
...
common_options : List[str] = [ 'keep-temp', 'skip-content-analysis' ]
