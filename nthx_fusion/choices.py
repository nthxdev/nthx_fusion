...
download_provider_set : DownloadProviderSet =\
{
	'github':
	{
		...
		'path': '/nthx_fusion/facefusion-assets/releases/download/{base_name}/{file_name}'
	},
	'huggingface':
	{
		'urls':
		...
		'path': '/nthx_fusion/{base_name}/resolve/main/{file_name}'
	}
}
