...
from nthx_fusion import content_analyser, core, state_manager
from nthx_fusion.cli_helper import render_table
from nthx_fusion.download import conditional_download, resolve_download_url
from nthx_fusion.face_store import clear_faces
from nthx_fusion.filesystem import get_file_extension
from nthx_fusion.types import BenchmarkCycleSet
from nthx_fusion.vision import count_video_frame_total, detect_video_fps
...
def run() -> Iterator[List[BenchmarkCycleSet]]:
	...
	benchmarks = []
	target_paths = [ nthx_fusion.choices.benchmark_set.get(benchmark_resolution) for benchmark_resolution in benchmark_resolutions if benchmark_resolution in nthx_fusion.choices.benchmark_set ]
