...
from nthx_fusion import ffmpeg
from nthx_fusion import logger, process_manager, state_manager, translator, video_manager
from nthx_fusion.audio import create_empty_audio_frame, get_audio_frame, get_voice_frame
from nthx_fusion.common_helper import get_first
from nthx_fusion.content_analyser import analyse_video
from nthx_fusion.filesystem import filter_audio_paths, is_video
from nthx_fusion.processors.core import get_processors_modules
from nthx_fusion.temp_helper import clear_temp_directory, create_temp_directory, move_temp_file, resolve_temp_frame_set
from nthx_fusion.time_helper import calculate_end_time
from nthx_fusion.types import ErrorCode
from nthx_fusion.vision import conditional_merge_vision_mask, detect_video_resolution, extract_vision_mask, pack_resolution, read_static_image, read_static_images, read_static_video_frame, restrict_trim_frame, restrict_video_fps, restrict_video_resolution, scale_resolution, select_video_frames, write_image
from nthx_fusion.workflows.core import is_process_stopping
...
def setup() -> ErrorCode:
	...
	if not state_manager.get_item('skip_content_analysis') and analyse_video(state_manager.get_item('target_path'), trim_frame_start, trim_frame_end):
		logger.error('processing stopped: target video was flagged by content analysis', __name__)
		return 3
