...
from nthx_fusion.audio import create_empty_audio_frame
from nthx_fusion.content_analyser import analyse_image
from nthx_fusion.filesystem import is_image
from nthx_fusion.processors.core import get_processors_modules
from nthx_fusion.temp_helper import clear_temp_directory, create_temp_directory, get_temp_file_path
from nthx_fusion.time_helper import calculate_end_time
from nthx_fusion.types import ErrorCode
from nthx_fusion.vision import conditional_merge_vision_mask, detect_image_resolution, extract_vision_mask, pack_resolution, read_static_image, read_static_images, restrict_image_resolution, scale_resolution, write_image
...
def setup() -> ErrorCode:
	if not state_manager.get_item('skip_content_analysis') and analyse_image(state_manager.get_item('target_path')):
		logger.error('processing stopped: target image was flagged by content analysis', __name__)
		return 3
